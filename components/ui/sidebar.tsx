...
export function SidebarProvider({
  ...
  const width = (style?.["--sidebar-width"] as string) || "18rem"

  return (
    <SidebarContext.Provider value={{ open, setOpen, width }}>
      <TooltipProvider>
        <div className="grid grid-cols-1 md:grid-cols-[auto_1fr]" style={style}>
          {children}
        </div>
      </TooltipProvider>
  ...
  return (
    <div
      className={cn(
        ...
        open ? "w-full md:w-[var(--sidebar-width)]" : "w-0 md:w-[var(--sidebar-width)]",
        variant === "inset" && "md:border-r-0",
        className,
      )}
